module PunyMCE
  ...
  PROFILES = {
    ...
    :source => {
      :toolbar => %w( bold italic underline strike increasefontsize decreasefontsize ul ol indent outdent left center right style textcolor removeformat link unlink editsource),
      :plugins => %w( Paste Link TextColor Entities EditSource )
    },
    :standard => {
